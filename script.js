...
function clicked() {
    ...
    if(x == hour){
        ...
        document.getElementById("imgarea").style.backgroundImage="url(./goodmorning.jpg)";
    }
    if(y == hour){
    ...
    if(z == hour){
        ...
        document.getElementById("imgarea").style.backgroundImage="url(./lunch.jpg)";
    }
    ...
    if(zz == hour){
        ...
        document.getElementById("imgarea").style.backgroundImage="url(./goodnight_image.jpg)";
